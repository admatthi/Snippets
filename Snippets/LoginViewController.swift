...
class LoginViewController: UIViewController, UITextFieldDelegate {
    ...
    func addstaticbooks() {
        ...
        ref?.child("Users").child(uid).child("Library").child("InProgress").child("Thinking in Bets").updateChildValues(["Author" : "Annie Duke", "BookID" : "22", "Description" : "Poker champion turned business consultant Annie Duke teaches you how to get comfortable with uncertainty and make better decisions as a result.", "Genre" : "Psychology", "Image" : "PS22", "Name" : "Thinking in Bets"])

        
        ref?.child("Users").child(uid).child("Library").child("InProgress").child("Mastery").updateChildValues(["Author" : "Robert Greene", "BookID" : "21", "Description" : "The bestseller author of The 48 Laws of Power, The Art of Seduction, and The 33 Strategies of War, Robert Greene has spent a liftime studying the laws of power. Now, he shares the secret path to greatness. With this seminal text as a guide, readers will learn how to unlock the passion within and become masters.", "Genre" : "Psychology", "Image" : "PS21", "Name" : "Mastery"])

        
        ref?.child("Users").child(uid).child("Library").child("InProgress").child("The Brain's Way of Healing").updateChildValues(["Author" : "Norman Doidge", "BookID" : "20", "Description" : "In his groundbreaking work The Brain That Changes Itself, Norman Doidge introduced readers to neuroplasticity—the brain’s ability to change its own structure and function in response to activity and mental experience. Now his revolutionary new book shows how the amazing process of neuroplastic healing really works.", "Genre" : "Psychology", "Image" : "PS20", "Name" : "The Brain's Way of Healing"])
